...
def start_detection(siren=None):
    proto = (r'C:\Users\tragu\OneDrive\Documents\animal detection\MobileNetSSD_deploy.prototxt.txt')
    model = (r'C:\Users\tragu\OneDrive\Documents\animal detection\MobileNetSSD_deploy.caffemodel')
    ...
    flag = 0
    c = 0  # Initialize c
    siren_wav = r"C:\Users\tragu\OneDrive\Documents\animal detection\Siren.wav"
